...
class Ui_Skill(object):
    def setupUi(self, Skill):
        ...
        self.spinBoxTotal.setToolTip(_fromUtf8(""))
        ...
        self.spinBoxMax.setToolTip(_fromUtf8(""))
        ...
        self.spinBoxLevel.setToolTip(_fromUtf8(""))
        ...
        self.spinBoxCost.setToolTip(_fromUtf8(""))
    ...
    def retranslateUi(self, Skill):
        ...
        self.spinBoxTotal.setStatusTip(_translate("Skill", "The total amount of SP used for this Skill", None))
        self.spinBoxMax.setStatusTip(_translate("Skill", "The higherst level for the current char level.", None))
        self.spinBoxLevel.setStatusTip(_translate("Skill", "The currently set level.", None))
